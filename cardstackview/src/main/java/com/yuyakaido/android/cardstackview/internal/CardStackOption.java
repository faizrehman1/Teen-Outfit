...
public class CardStackOption {
    ...
    public float swipeThreshold = 0.0f; // Percentage
    public float translationDiff = 12f; // DP
    public float scaleDiff = 0.02f; // Percentage
    public StackFrom stackFrom = StackFrom.Top;
    ...
    public List<SwipeDirection> swipeDirection = SwipeDirection.HORIZONTAL;
}
