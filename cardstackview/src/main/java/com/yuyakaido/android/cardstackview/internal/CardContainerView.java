...
public class CardContainerView extends FrameLayout {
    ...
    private void handleActionUp(MotionEvent event) {
        if (isDragging) {
            ...
            float motionCurrentY = 0.0f;

            Point point = Util.getTargetPoint(motionOriginX, motionOriginY, motionCurrentX, 0);
            Quadrant quadrant = Util.getQuadrant(motionOriginX, motionOriginY, motionCurrentX, 0);
            double radian = Util.getRadian(motionOriginX, motionOriginY, motionCurrentX, 0);
            double degree = 0;
...
//                        direction = SwipeDirection.Top;
    ...
    private void handleActionMove(MotionEvent event) {
        ...
        if (containerEventListener != null) {
            containerEventListener.onContainerDragging(getPercentX(), 0);
        }
    }
