...
public class Disco_Want_Adapter extends BaseAdapter  implements SectionIndexer,Filterable {
    ...
    public Disco_Want_Adapter(ArrayList<String> arrayList, Context mContext) {
